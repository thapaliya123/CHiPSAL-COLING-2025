...
if __name__ == "__main__":
    ...
    test_df = pd.read_csv(os.path.join(base_path, raw_test_csv_path))
    prompt_handler = PromptHandler()
    hate_speech_deector = HateSpeechDetector()


    for index, tweet in tqdm(test_df[['index', 'tweet']].values):
        ...
        try:
            ...
            print(f"Exception Occurred and error is {e}")
