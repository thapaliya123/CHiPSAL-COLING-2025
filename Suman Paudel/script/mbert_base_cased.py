...
def main():
    ...
    training_args = TrainingArguments(
        output_dir="./google-bert-bert-base-multilingual-cased",
    ...
    metrics_df.to_csv(f'google-bert-bert-base-multilingual-cased_metrics.csv', index=False)
    logging.info("Metrics saved to metrics.csv")

    # Save classification report
    report = classification_report(y_true, y_hat, output_dict=True)
    report_df = pd.DataFrame(report).transpose()
    report_df.to_csv(f'google-bert-bert-base-multilingual-cased_classification_report.csv')
